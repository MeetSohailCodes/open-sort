...
import { RenameStrategy, RenameLabelPosition, RenameDatePosition } from "./components/RenameOptions";
...
type Step = "setup" | "config" | "confirm" | "processing" | "done";
    ...
    <div className="min-h-screen bg-slate-800">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-slate-800/80 backdrop-blur-xl border-b border-slate-700/50 app-drag">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-slate-50 tracking-wide">Archivist</h1>
          ...
          <div className="flex items-center gap-4">
            <Chip
              ...
              variant="flat"
              className="bg-slate-700/50 border border-slate-600/30 app-no-drag"
              classNames={{
          ...
          <div className="max-w-6xl mx-auto px-6 py-4">
            <div className="flex items-center justify-center gap-2">
              {[
                ...
                const isPast =
                  (step === "config" && s.key === "setup") ||
                  (step === "confirm" && (s.key === "setup" || s.key === "config"));
                const Icon = s.icon;
      ...
      <main className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <AnimatePresence mode="wait">
            ...
            {/* STEP 2: Configuration - File Types & Ignores */}
            {step === "config" && (
              <motion.div
                key="config"
                variants={pageVariants}
              ...
              >
                <div className="text-center mb-10">
                  <h2 className="text-3xl font-bold text-slate-50 mb-3">File Configuration</h2>
                  <p className="text-slate-400 max-w-md mx-auto">
                    Select which file types to organize and folders to skip during scanning.
                  </p>
                </div>

                <div className="bg-slate-700/30 rounded-2xl border border-slate-600/30 p-8">
                  <ConfigPanel
                    ...
                    onToggleRename={setRenameEnabled}
                    onChangeRenameStrategy={setRenameStrategy}
                    onChangeRenameLabel={setRenameLabel}
                    onChangeRenameLabelPosition={setRenameLabelPosition}
                    onChangeRenameDatePosition={setRenameDatePosition}
                  />
                </div>
            ...
            {/* STEP 3: Confirmation - Review & Start */}
            {step === "confirm" && (
              <motion.div
                key="confirm"
                variants={pageVariants}
              ...
              >
                ...
                <div className="bg-slate-700/30 rounded-2xl border border-slate-600/30 p-8 space-y-6">
                  ...
                  <div className="flex items-start gap-3 p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl">
                    ...
                    <div>
                      <p className="text-sm font-medium text-blue-300">Safety Information</p>
                ...
                <div className="flex justify-between">
                  ...
                  <Button
                    ...
                    className="bg-emerald-500 text-white font-semibold px-10 hover:bg-emerald-400"
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-slate-800/80 backdrop-blur-sm border-t border-slate-700/30">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
          <p className="text-[10px] text-slate-500 uppercase tracking-widest">v1.1.0 • Professional Edition</p>
          <p className="text-[10px] text-slate-500">Local Processing Only</p>
        </div>
      </footer>
    </div>
  );
